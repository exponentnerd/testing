...
const TableDetailCard : React.FC = () => {
    return (
        <div className="flex items-center justify-center rounded-[12px] border-[0.25px] py-[9px] px-[10px] border-[#C3BFBF]">
            {/* content start */}
            <div className="flex flex-col py-[10px] gap-[20px] w-[366px]">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex items-center justify-center rounded-[50px] bg-[#00BDF9] px-[10px]">
                ...
                <div className="flex gap-[8px] items-center">
                    ...
                    <p className="font-poppins font-normal text-[14px] text-[#FFFFFF]">Up to 8 Guests</p>
                </div>
                {/* no of guest end */}
                {/* cost start */}
                ...
                <div className="flex gap-[12px]">
                    <div className="grow shrink-[0] basis-[0] pb-[3px]">
                        <Button fullWidth>Book Solo</Button>
                    </div>
                    <div className="grow shrink-[0] basis-[0] pb-[3px]">
                        <Button variant="outline" fullWidth>Create shared</Button>
                    </div>
                </div>
                {/* buttons end */}
            </div>
