                ...
                <div className="flex flex-col w-full max-w-[358px] gap-[100px] mb-[54px]">
                    ...
                    <div className="flex flex-col self-stretch items-start gap-[47px]">
                         ...
                         <div className="flex flex-col gap-[26px]">
                            <h1 className="font-poppins font-bold text-[30px] text-[#00BDF9]">Check your email</h1>
                            <p className="font-poppins font-semibold text-[20px] text-[#FFFFFF]">We sent a verification link to<br/> mynytmate@gmail.com</p>
                         </div>
                    </div>
                    {/*  */}
                    <div className="flex flex-col gap-[20px]">
                        <Button variant="solid" fullWidth onClick={()=> navigate("/verification-code")}>Enter code manually</Button>
